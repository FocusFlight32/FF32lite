...
#define PRESSURE_ALT_LOWPASS_SAMPLE_TIME 0.10f
...
void initFirstOrderFilter()
{
	...
	firstOrderFilters[PRESSURE_ALT_LOWPASS].previousInput  = sensors.pressureAlt10Hz;
    firstOrderFilters[PRESSURE_ALT_LOWPASS].previousOutput = sensors.pressureAlt10Hz;
